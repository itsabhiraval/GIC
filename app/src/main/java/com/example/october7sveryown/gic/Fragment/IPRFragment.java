...
public class IPRFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        context = getActivity();
        View rootView = inflater.inflate(R.layout.fragment_ipr,container, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.gtu.ac.in/uploads/19122016.pdf"));
                startActivity(i);
            }
        });
