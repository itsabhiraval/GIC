    ...
    private void load_event_date() {
        ...
        */AsyncTask<Void,Void,Void> task=new AsyncTask<Void,Void,Void>(){
            ...
            protected Void doInBackground(Void... voids) {
                ...
                Request request=new Request.Builder().url("http://192.168.1.3/gic/getData.php").build();
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++){
                        ...
                        MyData mydata=new MyData(jsonObject.getInt("event_id"),jsonObject.getString("event_name"),jsonObject.getString("event_venue"),event_date,jsonObject.getString("event_register_link"));
